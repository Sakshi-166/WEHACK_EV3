...
def classify_problem(description: str, location: str = ""):
    ...
    if best_match is None:
        return {
            "category": "general",
            "authority": "Relevant Grievance Authority",
            "reason": "The complaint could not be confidently matched to one of the current Kya Karu domains.",
            "official_channel": "Check the relevant official government grievance channel.",
